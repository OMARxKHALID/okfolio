...
export function TestimonialSection() {
  ...
  return (
    <section
      ...
      ref={containerRef}
      className="py-20 md:py-32 bg-cream-light relative overflow-hidden px-4"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-12 md:mb-20">
          ...
          <h2 className="general-title text-brown-dark leading-none text-4xl md:text-6xl">
            COLLABORATION
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {TESTIMONIALS.map((item, index) => (
            ...
            >
              <p className="font-paragraph text-brown-dark text-lg md:text-xl italic leading-relaxed">
                "{item.text}"
              </p>
              <div>
                <h4 className="font-heading text-2xl md:text-3xl text-brown-dark mb-1">
                  {item.name}
                </h4>
